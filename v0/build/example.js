...
var Ring = React.createClass({displayName: "Ring",
    ...
    componentDidUpdate: function(prevProps, prevState){
        if(this.state.onChange){
            this.state.onChange.call(this,this.state.rate);
        }
    },
    ...
    render: function() {
      ...
      return(
          React.createElement("div", {ref: "ring", className: RingClass, style: RingStyle}, 
             React.createElement("div", {className: "TextFrame", style: {borderRadius:radius+buttonRadius}}, 
                React.createElement("div", {className: "Text"}, Math.round(this.state.rate*100) + "%")
             ), 
             React.createElement("svg", {className: "SVG", width: cx*2, height: cy*2}, 
                React.createElement("circle", {className: "RateBg", cx: cx, cy: cy, r: radius, fill: "none"}), 
                React.createElement("circle", {className: "Rate", cx: cx, cy: cy, r: radius, fill: "none", strokeDasharray: c, strokeDashoffset: (1-this.state.rate)*c})
              ), 
              React.createElement("label", {ref: "button", className: "Button", style: ButtonStyle, onMouseDown: this.onMouseDown})
          )
      );
    }
});
...
var Ring01 = ReactDOM.render(
    React.createElement(Ring, {rate: 0.5, radius: 80, onChange: onChange}),
...
ReactDOM.render(
    React.createElement(Ring, {radius: 80, enable: false}),
